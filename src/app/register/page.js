      ...
      <div>
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`w-1/2 px-4 py-2.5 text-sm rounded-lg transition-all dark:hover:bg-[#1CA221] ${getButtonClass(
              "Laki-Laki",
              gender
            )}`}
          >
          ...
          <div className="flex items-center bg-white justify-center w-full py-8 px-6 lg:px-8 lg:w-3/5">
            <div className="w-full">
              <img
                src="/logo.png"
                alt="Logo"
                className="w-30 h-30 object-contain -mt-5 ml-63"
              />
              ...
              >
                {" "}
                {/* Gap ditingkatkan ke 4 untuk visual yang lebih jelas */}
                <div>
                  ...
                  <div className="md:col-span-2 mt-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:space-x-3 space-y-2 sm:space-y-0">
                      <button
                        ...
                        className={`w-full sm:w-1/2 px-4 py-2 text-sm transition-all rounded-lg ${getButtonClass(
                          "Donatur",
                          userRole
                        )}`}
                      >

...
export default function Login() {
  ...
  return (
    // 🟩 Tambahkan background putih untuk seluruh layar di sini
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-white lg:max-w-4xl">
        {/* Bagian kiri form login */}
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <div className="flex justify-center -mt-5">
            {/* Ubah logo.png jadi SVG */}
            <svg
...
>
  ...
  <div className="relative z-10 text-center text-white flex flex-col items-center justify-center p-6">
    ...
    <Link
      href="/register"
      className="inline-block mt-3 w-50 h-10 px-6 py-2 bg-[#059669] text-white font-medium transition-colors duration-300 transform rounded-lg hover:bg-[#037f58]"
    >
      Daftar
    </Link>
  </div>
